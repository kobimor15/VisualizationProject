function heatMap(){
    ...
    // parseInt(format(d.recovered)+100) ////////////////////////////////////
// Set tooltips
    var tip = d3.tip()
                .attr('class', 'd3-tip')
                .offset([-10, 0])
    ...
    svg.append("g")
        ...
        .enter().append("path")
        .attr("d", path)
        .style("fill", function(d) { return color( (populationById[d.id] - populationById[d.id+1] - populationById[d.id+2]) *100); }) //heatmap color by 
        .style('stroke', 'white')
